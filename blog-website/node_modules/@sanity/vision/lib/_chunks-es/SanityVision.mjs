...
function ParamsEditor(props) {
  ...
  let t4;
  $[14] !== handleChangeRaw ? (t4 = debounce(handleChangeRaw, 333), $[14] = handleChangeRaw, $[15] = t4) : t4 = $[15];
  const handleChange = t4, t5 = hasValidParams ? "default" : "critical";
  let t6;
  $[16] !== t ? (t6 = t("params.label"), $[16] = t, $[17] = t6) : t6 = $[17];
  let t7;
  $[18] !== t6 ? (t7 = /* @__PURE__ */ jsx(StyledLabel, { muted: !0, children: t6 }), $[18] = t6, $[19] = t7) : t7 = $[19];
  let t8;
  $[20] !== paramsError ? (t8 = paramsError && /* @__PURE__ */ jsx(Tooltip, { animate: !0, placement: "top", portal: !0, content: /* @__PURE__ */ jsx(Text, { size: 1, children: paramsError }), children: /* @__PURE__ */ jsx(Box, { padding: 1, marginX: 2, children: /* @__PURE__ */ jsx(Text, { children: /* @__PURE__ */ jsx(ErrorOutlineIcon, {}) }) }) }), $[20] = paramsError, $[21] = t8) : t8 = $[21];
  let t9;
  $[22] !== t7 || $[23] !== t8 ? (t9 = /* @__PURE__ */ jsx(InputBackgroundContainerLeft, { children: /* @__PURE__ */ jsxs(Flex, { children: [
    t7,
    t8
  ] }) }), $[22] = t7, $[23] = t8, $[24] = t9) : t9 = $[24];
  const t10 = props.value || defaultValue$1;
  let t11;
  $[25] !== editorRef || $[26] !== handleChange || $[27] !== t10 ? (t11 = /* @__PURE__ */ jsx(VisionCodeMirror, { ref: editorRef, initialValue: t10, onChange: handleChange }), $[25] = editorRef, $[26] = handleChange, $[27] = t10, $[28] = t11) : t11 = $[28];
  let t12;
  return $[29] !== t11 || $[30] !== t5 || $[31] !== t9 ? (t12 = /* @__PURE__ */ jsxs(Card, { flex: 1, tone: t5, "data-testid": "params-editor", children: [
    t9,
    t11
...
const PinnedReleasePerspectiveOption = (t0) => {
  ...
  let t4;
  return $[6] !== t3 || $[7] !== text ? (t4 = /* @__PURE__ */ jsx("option", { value: "pinnedRelease", disabled: t3, children: text }), $[6] = t3, $[7] = text, $[8] = t4) : t4 = $[8], t4;
};
